...
const { title, author, pages, publicationDate, genres, hasMovieAdaptation } =
  book;
console.log(title, author, pages, publicationDate, hasMovieAdaptation);
...
const updateBook = {
  ...
  // Overwriting an existiing property
...
console.log("jonas" && "Some stringn");
...
console.log(false || true || "Jonas");

// const getBook = (id) => data.find((d) => d.id === id);

function getTotalWeviesCount(book) {
